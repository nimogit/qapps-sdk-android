...
public class QappsConfigTests {

    @Test
    public void constructor(){
        QappsConfig config = new QappsConfig(getContext(), "Som345345", "fsdf7349374");
    ...
    public void settingAllValues() {
        ...
        QappsStore cs = new QappsStore(c);

        QappsStarRating.RatingCallback rc = new QappsStarRating.RatingCallback() {
            @Override
        ...
        Assert.assertEquals(cs, config.qappsStore);
    ...
    void assertDefaultValues(QappsConfig config, boolean includeConstructorValues){
        ...
        Assert.assertEquals(null, config.qappsStore);

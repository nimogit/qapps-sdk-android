...
public class QappsStoreTests {
    QappsStore store;

    @Before
    public void setUp() {
        store = new QappsStore(getContext());
        store.clear();
    }
    ...
    public void testConstructor_nullContext() {
        try {
            new QappsStore(null);
            fail("expected IllegalArgumentException when calling QappsStore() ctor with null context");
    ...
    public void testConstructor() {
        ...
        new QappsStore(mockContext);
        verify(mockContext).getSharedPreferences("QAPPS_STORE", Context.MODE_PRIVATE);
    }
    ...
    public void testEventsList_badJSON() {
        ...
        final SharedPreferences prefs = getContext().getSharedPreferences("QAPPS_STORE", Context.MODE_PRIVATE);

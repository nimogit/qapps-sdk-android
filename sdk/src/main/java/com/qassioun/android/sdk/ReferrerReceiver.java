 ...
 * ADB Testing
 * adb shell
 * am broadcast -a com.android.vending.INSTALL_REFERRER --es "referrer" "qapps_cid%3Dcb14e5f33b528334715f1809e4572842c74686df%26qapps_cuid%3Decf125107e4e27e6bcaacb3ae10ddba66459e6ae"
**/
//******************************************************************************
        ...
        try
        {
            ...
            if ((null != intent) && (intent.getAction().equals("com.android.vending.INSTALL_REFERRER")))
            {
                ...
                if (null != rawReferrer)
                {
                    ...
                    Log.d(Qapps.TAG, "Referrer: " + referrer);

                    String[] parts = referrer.split("&");
                    String cid = null;
                    String uid = null;
                    for (String part : parts) {
                        if (part.startsWith("qapps_cid")) {
                            cid = part.replace("qapps_cid=", "").trim();
                        }
                        if (part.startsWith("qapps_cuid")) {
                            uid = part.replace("qapps_cuid=", "").trim();
                        }
                    }
                    String res = "";
                    if(cid != null)

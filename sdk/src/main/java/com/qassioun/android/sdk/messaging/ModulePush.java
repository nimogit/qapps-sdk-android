...
class ModulePush {
    ...
    static class MessageImpl implements QappsPush.Message {
        final String id;
        private final String title, message, sound;
        private final Integer badge;
        private final Uri link;
        private final URL media;
        private final List<QappsPush.Button> buttons;
        private final Map<String, String> data;

        static class Button implements QappsPush.Button {
            private final QappsPush.Message message;
            private final int index, icon;
            private final String title;
            private final Uri link;

            Button(QappsPush.Message message, int index, String title, Uri link) {
            ...
            Button(QappsPush.Message message, int index, String title, Uri link, int icon) {
                this.message = message;
                this.index = index;
                this.title = title;
                this.link = link;
        ...
        MessageImpl(Map<String, String> data) {
            ...
            if (data.get(KEY_LINK) != null) {
                try {
                    ...
                    Log.w("Qapps", "Cannot parse message link", e);
                }
            }
            this.link = uri;
            ...
            try {
                ...
                Log.w("Qapps", "Bad media value received, ignoring");
            }
            this.media = u;
            ...
            if (json != null) {
                try {
                    ...
                    Log.w("Qapps", "Failed to parse buttons JSON", e);
                }
            }
        ...
        @Override
        public List<QappsPush.Button> buttons() {
            return buttons;
        }
        ...
        public void recordAction(Context context, int buttonIndex) {
            ...
            Qapps.sharedInstance().recordEvent(PUSH_EVENT_ACTION, map, 1);
        }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            dest.writeMap(data);
            Log.d("Qapps", "written: " + data.get(KEY_ID));
        }
        ...
        public static final Parcelable.Creator<MessageImpl> CREATOR = new Parcelable.Creator<MessageImpl>() {
            ...
            public MessageImpl createFromParcel(Parcel in) {
                ...
                Log.d("Qapps", "read: " + map.get(KEY_ID));

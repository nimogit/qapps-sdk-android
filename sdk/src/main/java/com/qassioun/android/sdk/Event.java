 ...
 * https://qassioun.com/resources/reference/custom-events
 */
class Event {
    ...
    JSONObject toJSON() {
        ...
        try {
            ...
            if (Qapps.sharedInstance().isLoggingEnabled()) {
                Log.w(Qapps.TAG, "Got exception converting an Event to JSON", e);
            }
        }
    ...
    static Event fromJSON(final JSONObject json) {
        ...
        try {
            ...
            if (Qapps.sharedInstance().isLoggingEnabled()) {
                Log.w(Qapps.TAG, "Got exception converting JSON to an Event", e);
            }
            event = null;
        }

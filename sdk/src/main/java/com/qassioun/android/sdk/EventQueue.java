...
public class EventQueue {
    private final QappsStore qappsStore_;

    /**
     * Constructs an EventQueue.
     * @param qappsStore backing store to be used for local event queue persistence
     */
    EventQueue(final QappsStore qappsStore) {
        qappsStore_ = qappsStore;
    }
     ...
     */
    int size() {
        return qappsStore_.events().length;
   }
    ...
    String events() {
        ...
        final List<Event> events = qappsStore_.eventsList();
        ...
        qappsStore_.removeEvents(events);
    ...
    void recordEvent(final String key, final Map<String, String> segmentation, final Map<String, Integer> segmentationInt, final Map<String, Double> segmentationDouble, final int count, final double sum, final double dur, UtilsTime.Instant instant) {
        ...
        qappsStore_.addEvent(key, segmentation, segmentationInt, segmentationDouble, timestamp, hour, dow, count, sum, dur);
    }

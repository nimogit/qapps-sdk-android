 ...
 * data store, and 2) while the Qapps singleton is synchronized to ensure only a single writer
 * at a time from the public API side, the internal implementation has a background thread that
 * submits data to a Qapps server, and it writes to this store as well.
 *
 * NOTE: This class is only public to facilitate unit testing, because
 *       of this bug in dexmaker: https://code.google.com/p/dexmaker/issues/detail?id=34
 */
public class QappsStore {
    private static final String PREFERENCES = "QAPPS_STORE";
    private static final String PREFERENCES_GCM = "com.qassioun.android.api.messaging";
    ...
    private static final String CONSENT_GCM_PREFERENCES = "com.qassioun.android.api.messaging.consent.gcm";

    /**
     * Constructs a QappsStore object.
     * @param context used to retrieve storage meta data, must not be null.
     * @throws IllegalArgumentException if context is null
     */
    QappsStore(final Context context) {
        if (context == null) {

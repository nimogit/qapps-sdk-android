...
#ifdef DEBUG
#define TAG_NAME "qapps_breakpad_cpp"
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *pjvm, void *reserved) {
    ...
    auto myClass = env->FindClass("ly/count/android/QappsNative");
    LOGD("class found");
...
JNIEXPORT jint JNICALL Java_ly_count_android_sdknative_QappsNative_testCrash(JNIEnv* env,
                                                                           jobject obj){
...
JNIEXPORT jint JNICALL Java_ly_count_android_sdknative_QappsNative_init(JNIEnv* env,
                                                                      jobject jobj,
